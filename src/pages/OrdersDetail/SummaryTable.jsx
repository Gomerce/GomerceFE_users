...
const rows = [
  createData('1', ['Laptop Bag', 'USB Back Pack', 'Antitheft Bag'], 1, '$$$$', '$$$$'),
  createData('2', ['Laptop Bag', 'USB Back Pack', 'Antitheft Bag'], 1, '$$$$', '$$$$'),
  createData('3', ['Laptop Bag', 'USB Back Pack', 'Antitheft Bag'], 1, '$$$$', '$$$$')
]
const SummaryTable = () => {
  return (
    <Box sx={{ width: '100%' }}>
      <TableContainer sx={{ marginTop: '25px', marginBottom: '25px' }}>
              ...
              <TableRow key={row.id}>
                ...
                <TableCell align="left" sx={{ width: '168px' }} padding="normal">
                  {row.item.map((item, index) => {
                    return <Typography variant="caption" key={index}>{`${item + ' '}`}</Typography>
                  })}
                </TableCell>
        ...
        <Box display={'flex'} flexDirection={'column'} mt={3}>
          <Typography variant="caption" sx={{ textTransform: 'uppercase' }} align={'right'}>
