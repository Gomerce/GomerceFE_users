...
import StyledCartBadge from './StyledBadge'
        ...
        <AppBar position="sticky" sx={customAppBarStyle}>
            <Toolbar sx={toolBarStyles}>
                ...
                <StyledButtonGroup>
                    {!matchesLaptop ? (
                        <>
                            <Button variant="outlined" startIcon={<FavoriteBorderIcon/>} component={Link}
                                    to="/wishlist">
                                Wishlist
                            </Button>
                            <Button
                            ...
                            <Button
                                variant="outlined"
                                startIcon={<StyledCartBadge cartCount={cartItems ? cartItems?.length : 0}/>}
                                component={Link}
                                to="/cart">
                                &nbsp;&nbsp;Cart
                            </Button>
                        ...
                        <>
                            ...
                            <IconButton>
                                <StyledCartBadge cartCount={cartItems ? cartItems?.length : 0}/>
                            </IconButton>
                        </>
                    )}
                </StyledButtonGroup>
