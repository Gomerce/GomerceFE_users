...
import { Box, Button, Grid, InputLabel, Link, Stack, TextField, Typography } from '@mui/material'
import './styles.css'
            ...
            >
              <Grid container direction="column" rowGap={2}>
                <Grid container direction="column" alignItems="center">
                  <p ref={errRef} aria-live="assertive" className={errMsg ? 'error' : 'offscreen'}>
                    {errMsg}
                  </p>
                ...
                <Stack component="form" spacing={2} onSubmit={handleSubmit}>
                  ...
                  <Box>
                    ...
                    <TextField
                      ...
                      helperText={
                        !isValidMatch && isMatchFocus && 'Must match the above password input field'
                      }
                      fullWidth
                      onChange={(event) => {
