...
import footerData from '../../data/footerColumnData'
...
const Footer = () => {
  return (
    <FooterContainer>
      <FooterContent>
        <Typography variant="h6" mr={'6%'} color={'#F4F5EF'} fontWeight={700} fontSize={18}>
          Gomerce
        </Typography>
        <Box
          sx={{
        ...
        >
          {footerData.map((setup) => {
            return <FooterColumn key={setup.id} title={setup.title} links={setup.links} />
          })}
        </Box>
      </FooterContent>
